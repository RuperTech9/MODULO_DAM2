...
public class ComprimirArchivos {
    ...
    public static void main(String[] args) {
        ...
        archivosAComprimir.add("./src/Programacion/T01_Procesos/Practica/archivo1.txt");
        archivosAComprimir.add("./src/Programacion/T01_Procesos/Practica/archivo2.txt");
        archivosAComprimir.add("./src/Programacion/T01_Procesos/Practica/archivo3.txt");
