...
public class E09c_EjecutarVerificarPalindromoConArchivo {
    ...
    public static void main(String[] args) throws IOException {
        ...
        File directorio = new File("./src/ProgramacionServiciosYProcesos/DB4O");
        ...
        File fIn = new File("./src/ProgramacionServiciosYProcesos/DB4O/entrada.txt");
        ...
        File fErr = new File("./src/ProgramacionServiciosYProcesos/DB4O/error.txt");
