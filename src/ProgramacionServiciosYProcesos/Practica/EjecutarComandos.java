...
public class EjecutarComandos {
    ...
    public static void main(String[] args) {
        ...
        File archivoSalida = new File("./src/ProgramacionServiciosYProcesos/Practica/salida.txt");
        resultado = ejecutor.ejecutarComandoConRedireccion("DIR", archivoSalida);
