...
public class EjercicioProfe4_MainCancion {
    public static void main(String[] args) throws IOException {
        //Creamos un fichero para guardar las canciones
        Scanner sc = new Scanner(System.in);
        String fichero = "./src//AccesoADatos//T01_Ficheros/canciones1.dat"; // Nombre del archivo donde se guardarán las canciones
                ...
                case 1:
                    ...
                    try {
                        ...
                        if (new File(fichero).exists()) {
                            objectOS = new EjercicioProfe4_MiObjectOutputStream(fileout);
                        } else {
                        ...
                        EjercicioProfe4_Cancion cancion = new EjercicioProfe4_Cancion(id, año, titulo, artista, duracion, española);
                ...
                case 2:
                    ...
                    try (FileInputStream fileIn = new FileInputStream(fichero);
                        ...
                        while (fileIn.available() > 0) {
                            EjercicioProfe4_Cancion cancion = (EjercicioProfe4_Cancion) objectIS.readObject();
