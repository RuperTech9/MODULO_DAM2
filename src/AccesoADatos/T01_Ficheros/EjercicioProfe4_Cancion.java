...
public class EjercicioProfe4_Cancion implements Serializable {
    //Atributos
    private int id;
    private int año;
    ...
    //Constructores
    public EjercicioProfe4_Cancion(int id, int año, String titulo, String artista, String duracion, boolean española) {
        this.id = id;
        this.año = año;
        this.titulo = titulo;
    ...
    public EjercicioProfe4_Cancion(){
        this.id = 0;
        this.año = 0;
        this.titulo = null;
        this.artista = null;
