...
public class CrearCancion2XML {
    ...
    public static void main(String[] args) throws IOException {
        ...
        File f = new File("./src//AccesoADatos//T01_Ficheros/TareaFicheroAleatorioCanciones/canciones.dat");
        ...
        try
        {
            ...
            for(int i = 0; i < 5; i++)
            {
                ...
                crearElemento("Espanola",
                        Boolean.toString(cancion.isCancionEspanola()),
                        raiz, document);
            ...
            Result result = new StreamResult(
                    new File("src\\P05_FicherosXML\\ficheros\\canciones2.xml"));
