...
public class EjercicioProfe4_EscribirLinea {
    public static void main(String[] args) throws IOException{
        ...
        File fichero1 = new File("./src//AccesoADatos//T01_Ficheros//DB4O//pruebaEscribir.txt");
        ...
        if(!fichero1.exists()){
            ...
            if(respuesta.equalsIgnoreCase("Y")){
                ...
                File ficheroUser = new File("./src//AccesoADatos//T01_Ficheros//DB4O//" + nombreFichero);
            ...
            try { //usaremos BufferedReader y BufferedWriter
                BufferedReader br = new BufferedReader(new FileReader("./src//AccesoADatos//T01_Ficheros//DB4O//pruebaEscribir.txt")); //Lectura
                BufferedWriter bw = new BufferedWriter(new FileWriter("./src//AccesoADatos//T01_Ficheros//DB4O//pruebaEscribir.txt")); //Escritura
